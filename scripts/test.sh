...
#SBATCH -o ./logs/ddpg_test.txt
#SBATCH -e ./logs/ddpg_test.err
...
# constants
CONFIG=src/ddpg_model/configs/config2.yaml
CKPT_DIR=ddpg_runs/ddpg_exp1/weights
...
python -u src/train_ddpg.py --config "${CONFIG}"
